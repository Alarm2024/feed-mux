...
pub struct Config {
    ...
    /// Comma-separated SOL lamport sizes for KEEP-like Titan hop-1 board
    pub titan_board_sizes_lamports: Option<String>,
...
impl Config {
    pub fn from_env() -> Self {
        Self {
            ...
            titan_board_sizes_lamports: env_optional("TITAN_BOARD_SIZES_LAMPORTS"),
